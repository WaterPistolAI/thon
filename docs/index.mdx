...
- **Web Dashboard**: Streamlit dashboard for instance, group, and Lemonade management
...
| **Streamlit Dashboard** | Web UI for instance, group, and Lemonade management (:8501) |
| **FastAPI REST API** | Programmatic API for instances, groups, Lemonade, auth (:8100) |
